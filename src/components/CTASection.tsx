...
const CTASection = () => {
  return (
    <section id="contact" className="relative py-32 lg:py-44 px-6 overflow-hidden" aria-labelledby="cta-heading">
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        >
          <span className="text-[11px] tracking-[0.2em] uppercase text-primary font-mono">Ready to scale?</span>
          <h2 id="cta-heading" className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mt-4 mb-8 leading-[1.05]">
            Let&apos;s dominate
            <br />
            <span className="italic text-gradient-primary font-medium">Amazon together</span>
          </h2>
