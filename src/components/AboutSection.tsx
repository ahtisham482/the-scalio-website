...
const AboutSection = () => {
  return (
    <section id="about" className="relative py-32 lg:py-40 px-6 overflow-hidden" aria-labelledby="about-heading">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <span className="text-[11px] tracking-[0.2em] uppercase text-primary font-mono">About Us</span>
            <h2 id="about-heading" className="text-4xl md:text-5xl lg:text-6xl font-display font-bold mt-4 leading-[1.05]">
              Your growth
              <br />
              <span className="italic text-gradient-primary font-medium">is our obsession</span>
            </h2>
            ...
            <p className="text-muted-foreground font-body text-base leading-[1.9] font-light max-w-md">
              The Scalio is a full-service Amazon FBA agency built by sellers, for sellers.
              We&apos;ve helped over 200 brands launch, optimize, and scale to 7- and 8-figure
              revenue on Amazon&apos;s marketplace.
            </p>
            <p className="text-muted-foreground font-body text-base leading-[1.9] font-light max-w-md mt-5">
              From product research and listing optimization to PPC management and
              supply chain logistics — we handle every aspect of your Amazon business
