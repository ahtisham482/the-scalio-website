...
const steps = [
  {
    ...
    number: "01",
    title: "Free Audit",
    description: "We deep-dive into your account — listings, PPC, keywords, competitors — and deliver a full growth roadmap within 48 hours.",
    accent: "265 85% 65%",
  },
  {
    icon: Crosshair,
    ...
    description: "Your dedicated team builds a tailored launch or scaling plan — product positioning, keyword architecture, and ad structure mapped out.",
    accent: "310 70% 60%",
  },
  {
    icon: Rocket,
    ...
    description: "We execute across every lever — listings go live, PPC campaigns launch, and we iterate daily on data to accelerate rank and sales.",
    accent: "42 80% 60%",
  },
  {
    icon: TrendingUp,
    ...
    description: "Once we hit profitability, we pour fuel on the fire — expanding SKUs, entering new markets, and compounding your revenue month over month.",
    accent: "265 85% 65%",
  },
];
...
const StepCard = ({ step, index }: { step: typeof steps[0]; index: number }) => {
  ...
  return (
    <motion.div ref={ref} style={{ y, opacity }} className="relative flex gap-5 md:gap-8">
      ...
      <div className="flex flex-col items-center shrink-0">
        ...
        >
          <Icon className="w-5 h-5 md:w-6 md:h-6" style={{ color: `hsl(${step.accent})` }} />
        </div>
    ...
    >
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 id="how-it-works-heading" className="text-3xl md:text-5xl lg:text-6xl font-display font-bold leading-[1.05] mb-6">
            From audit to{" "}
            <span className="text-gradient-primary italic font-medium">empire</span>
          </h2>
          <p className="text-muted-foreground font-body text-base md:text-lg max-w-lg mx-auto leading-relaxed">
            A proven four-step process that turns underperforming listings into category leaders.
          </p>
        </motion.div>
